#!/usr/bin/env python3
"""
Create query file for a USA city - TEST VERSION with fewer queries
"""
import sys
import math
...
# Reduced queries for testing - just the most important ones
QUERIES = [
    'event planners',
    'event organizers', 
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 create_usa_queries_test.py <city_key>")
        sys.exit(1)
